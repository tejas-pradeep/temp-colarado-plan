export const DAYS = [
  {
    ...
    items: [
      ...
      {
        time: "8:30 \u2013 9:30 AM",
        title: "Coffee & Settle In @ Inxpot Coffeehouse",
        desc: "Inxpot is in River Run Village right near the gondola \u2014 library-lounge vibe, free WiFi, great coffee and breakfast burritos. Opens at 7am. Post up with a coffee and ease into the morning.",
        tag: "FOOD",
        icon: "\u2615",
      ...
      },
      {
        time: "9:30 \u2013 10:30 AM",
        title: "Meeting",
        desc: "Take your meeting right at Inxpot \u2014 you\u2019re already set up with WiFi and coffee. You\u2019re in the village when you\u2019re done.",
        tag: "MEETING",
        icon: "\uD83D\uDCBC",
        mapQuery: "Inxpot Coffeehouse, Keystone, CO",
        travelTime: null,
      ...
      },
      {
        ...
        desc: "Text your friends to meet you at Summit House at the top of the gondola around 11:30 for a drink. Blue/black skiers can get there easily from anywhere on the mountain. You\u2019re already up there \u2014 grab a table and wait for them. Quick hangout before they hit more runs and you ride down.",
        tag: "MEETUP",
        icon: "\uD83E\uDD1D",
      ...
      },
      {
        ...
        desc: "Back in the village \u2014 grab lunch at New Moon Caf\u00e9 (classic rock vibes, full menu all day) or Kickapoo Tavern. Warm up by the big firepit in River Run Village Plaza.",
        tag: "FOOD",
        icon: "\uD83C\uDF7D\uFE0F",
